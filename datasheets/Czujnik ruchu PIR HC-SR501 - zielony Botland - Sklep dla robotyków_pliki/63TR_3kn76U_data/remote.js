...
L:"ytp-mdx-manual-pairing-popup-dialog",T:{role:"dialog"},R:[{G:"div",L:"ytp-mdx-manual-pairing-popup-dialog-inner-content",R:[{G:"div",L:"ytp-mdx-manual-pairing-popup-title",ba:"Wkr\u00f3tce wycofamy mo\u017cliwo\u015b\u0107 \u0142\u0105czenia si\u0119 z telewizorem za pomoc\u0105 kodu w przegl\u0105darce"},{G:"div",L:"ytp-mdx-manual-pairing-popup-buttons",R:[{G:"button",ia:["ytp-button","ytp-mdx-manual-pairing-popup-learn-more"],ba:"Wi\u0119cej informacji"},{G:"button",ia:["ytp-button","ytp-mdx-manual-pairing-popup-ok"],
ba:"OK"}]}]}]});this.u=new g.tM(this,250);this.learnMoreButton=this.ha("ytp-mdx-manual-pairing-popup-learn-more");this.okButton=this.ha("ytp-mdx-manual-pairing-popup-ok");g.C(this,this.u);this.P(this.learnMoreButton,"click",this.B);this.P(this.okButton,"click",this.C)},Y6=function(){g.U.call(this,{G:"div",
L:"ytp-mdx-popup-dialog",T:{role:"dialog"},R:[{G:"div",L:"ytp-mdx-popup-dialog-inner-content",R:[{G:"div",L:"ytp-mdx-popup-title",ba:"Nie korzystasz teraz z konta"},{G:"div",L:"ytp-mdx-popup-description",ba:"Filmy, kt\u00f3re ogl\u0105dasz, mog\u0105 zosta\u0107 dodane do historii ogl\u0105dania YouTube TV i wp\u0142ywa\u0107 na pojawiaj\u0105ce si\u0119 tam rekomendacje. Aby tego unikn\u0105\u0107, anuluj proces i zaloguj si\u0119 w YouTube na komputerze."},{G:"div",L:"ytp-mdx-privacy-popup-buttons",
R:[{G:"button",ia:["ytp-button","ytp-mdx-privacy-popup-cancel"],ba:"Anuluj"},{G:"button",ia:["ytp-button","ytp-mdx-privacy-popup-confirm"],ba:"Potwierd\u017a"}]}]}]});this.u=new g.tM(this,250);this.cancelButton=this.ha("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.ha("ytp-mdx-privacy-popup-confirm");g.C(this,this.u);this.P(this.cancelButton,"click",this.B);this.P(this.confirmButton,"click",this.C)},Z6=function(a){g.U.call(this,{G:"div",
...
c=g.T(b,128)?g.sK("B\u0142\u0105d w: $RECEIVER_NAME",c):b.Hb()||g.T(b,4)?g.sK("Film jest odtwarzany na: $RECEIVER_NAME",c):g.sK("Po\u0142\u0105czono z: $RECEIVER_NAME",c);a.za("statustext",c);a.u.show()}else a.u.hide()},$6=function(a,b){g.sR.call(this,"Odtw\u00f3rz na",0,a,b);
...
this.gi={key:q4(),name:"Ten komputer"};this.nh=null;this.subscriptions=[];this.Rz=this.wb=null;this.gm=[this.gi];this.ol=this.gi;this.Mc=new g.SK(64);this.dE=0;this.Pe=-1;this.np=null;this.ls=this.yu=!1;this.Ln=this.Mp=null;if(!g.DD(this.player.S())){a=this.player;var b=g.MN(a);b&&(b=b.Cl())&&(b=new $6(a,b),g.C(this,b));b=new Z6(a);g.C(this,b);g.WN(a,b.element,4);this.Mp=new Y6;g.C(this,this.Mp);g.WN(a,this.Mp.element,4);g.P(this.player.S().experiments,"pair_servlet_deprecation_warning_enabled")&&
...
break;case -1:this.tb(new g.SK(64));break;case -1E3:this.tb(new g.SK(128,{errorCode:"mdx.remoteerror",errorMessage:"Zdalne odtwarzanie tego filmu jest niemo\u017cliwe."}))}a=l6(this.wb).u;var b=this.D;(a||b?a&&b&&a.trackName==b.trackName&&a.languageCode==b.languageCode&&a.languageName==b.languageName&&a.kind==b.kind:1)||(this.D=a,BJa(this,a));a=l6(this.wb);-1===a.volume||Math.round(this.J.getVolume())===a.volume&&this.J.isMuted()===a.muted||this.U.isActive()||this.RH()}else AJa(this)};
...
$6.prototype.ji=function(a){return"cast-selector-receiver"===a?"Prze\u015blij...":this.gm[a].name};
